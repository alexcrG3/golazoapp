    ...
    <>
      <section className="mt-6 px-4">
        <div className="glass overflow-hidden rounded-3xl">
          ...
          <div className="grid grid-cols-[16px_1fr_repeat(4,_18px)_22px_22px] sm:grid-cols-[28px_1fr_repeat(5,_28px)_36px] gap-1 sm:gap-2 px-3 sm:px-5 py-2 text-[10px] uppercase tracking-widest text-white/40">
            <span>#</span>
            <span>Equipo</span>
