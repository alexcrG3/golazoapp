...
En el chat de desarrollo, tienes a tu disposición varios comandos rápidos (o _slash commands_) que te permiten controlar la ejecución del asistente, delegar tareas pesadas, navegar por la web o guardar reglas personalizadas. A continuación se detalla qué es, para qué sirve y cuándo utilizar cada uno de ellos.
...
- **Cuándo utilizarlo:**
  ...
  - Si quieres saber cuál es la diferencia entre dos tecnologías (ej. _Vite vs Next.js_).
- **Ejemplo de uso:**
  ```text
...
- **Qué es:** Un programador de tareas (_cron jobs_) y temporizador de alertas.
...
- **Cuándo utilizarlo:**
  ...
  - Si tienes un estándar de código preferido (ej. _"usa siempre Tailwind CSS"_ o _"no uses punto y coma"_).
- **Ejemplo de uso:**
  ```text
