...
_(El `-u origin main` solo es necesario la primera vez; de ahí en adelante puedes usar simplemente `git push`)_.
...
- **Framework Preset:** Selecciona **Vite** (o déjalo en _Other_ si detecta automáticamente la configuración del proyecto).
...
_Haz clic en **Add** por cada variable para guardarla._
